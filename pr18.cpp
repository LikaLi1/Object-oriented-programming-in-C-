...
class PaymentFacade
{
    ...
    PaymentFacade() {}
    PaymentFacade(const PaymentFacade&) = delete;
    PaymentFacade& operator=(const PaymentFacade&) = delete;

public:
    static PaymentFacade& getInstance()
    {
        static PaymentFacade instance;
        return instance;
    }
...
int main()
{
    ...
    PaymentFacade& pay = PaymentFacade::getInstance();
    ...
    PaymentFacade& pay2 = PaymentFacade::getInstance();
    cout << ( &pay == &pay2 ? "S!\n" : "D!\n" );
